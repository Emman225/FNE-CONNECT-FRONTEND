...
const MOCK_QUOTES = [
    { id: 1, number: 'DEV-2023-001', clientName: 'Jean Doe', clientPhone: '0708091011', date: '2023-12-15', amount: 150000, status: 'draft', isComplete: true },
    { id: 2, number: 'DEV-2023-002', clientName: 'Entreprise ABC', clientPhone: '0102030405', date: '2023-12-16', amount: 2500000, status: 'pending', isComplete: true },
    { id: 3, number: 'DEV-2023-003', clientName: 'Lamine Touré', clientPhone: '0505443322', date: '2023-12-18', amount: 85000, status: 'draft', isComplete: false },
];
...
const QuoteListPage = () => {
    ...
    const handleConvert = (quote, toType) => {
        if (toType === 'proforma') {
            if (window.confirm(`Voulez-vous convertir le devis ${quote.number} en Proforma ?`)) {
                alert(`Devis ${quote.number} converti en Proforma avec succès !`);
            ...
            if (window.confirm(`Voulez-vous convertir le devis ${quote.number} en Facture ?`)) {
                alert(`Devis ${quote.number} converti en Facture avec succès !`);
