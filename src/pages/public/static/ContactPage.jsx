                        ...
                        <div>
                            ...
                            <div style={{ display: 'flex', flexDirection: 'column', gap: '2rem' }}>
                                <div style={{ display: 'flex', gap: '1rem', alignItems: 'center' }}>
                                    <div style={{ padding: '1rem', background: 'var(--bg-card)', borderRadius: '50%', color: 'var(--primary)' }}><Mail /></div>
                                    <div>
                                ...
                                <div style={{ display: 'flex', gap: '1rem', alignItems: 'center' }}>
                                    <div style={{ padding: '1rem', background: 'var(--bg-card)', borderRadius: '50%', color: 'var(--primary)' }}><Phone /></div>
                                    <div>
                                ...
                                <div style={{ display: 'flex', gap: '1rem', alignItems: 'center' }}>
                                    <div style={{ padding: '1rem', background: 'var(--bg-card)', borderRadius: '50%', color: 'var(--primary)' }}><MapPin /></div>
                                    <div>
