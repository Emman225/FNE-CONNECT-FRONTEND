...
const DocumentTable = ({ documents, type = 'invoice', onPay, onGenerateFne, onConvert }) => {
    return (
                            ...
                            <td style={{ padding: '1rem 1.5rem', borderTopRightRadius: '12px', borderBottomRightRadius: '12px' }}>
                                <div style={{ display: 'flex', gap: '0.5rem', justifyContent: 'flex-end' }}>
                                    ...
                                    {['draft', 'pending'].includes(doc.status) && (
                                        <>
                                            {((doc.status === 'pending') || (doc.status === 'draft' && doc.isComplete)) && onPay && (
                                                ...
                                                <>
                                                    {type === 'quote' && (
                                                        <div style={{ display: 'flex', gap: '2px' }}>
                                                            <button onClick={() => onConvert(doc, 'proforma')} className="btn-icon" style={{ color: 'var(--secondary)', width: '32px', height: '32px', borderRadius: '8px', display: 'flex', alignItems: 'center', justifyContent: 'center', transition: 'all 0.2s', background: 'transparent', border: 'none', cursor: 'pointer' }}
                                                                onMouseEnter={e => e.currentTarget.style.backgroundColor = 'var(--secondary-lighter)'}
                                                                onMouseLeave={e => e.currentTarget.style.backgroundColor = 'transparent'}
                                                                title="Convertir en Proforma">
                                                                <FileText size={16} />
                                                            </button>
                                                            <button onClick={() => onConvert(doc, 'invoice')} className="btn-icon" style={{ color: 'var(--primary)', width: '32px', height: '32px', borderRadius: '8px', display: 'flex', alignItems: 'center', justifyContent: 'center', transition: 'all 0.2s', background: 'transparent', border: 'none', cursor: 'pointer' }}
                                                                onMouseEnter={e => e.currentTarget.style.backgroundColor = 'var(--primary-lighter)'}
                                                                onMouseLeave={e => e.currentTarget.style.backgroundColor = 'transparent'}
